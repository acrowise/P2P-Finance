...
(function($, document, undefined) {
    ...
    var CLASS_ICON_PULLDOWN = 'mui-icon-arrowthindown';
   ...
   var handle = function(event, target) {
    ...
    window.addEventListener('tap', function(e) {
        ...
        if (!targetTab) {
         ...
         if(targetTab.getAttribute('href')=='assets.html' && !localStorage.getItem('LEAD_TOKEN')){
			 return;
		}
        var activeTab;
        var activeBodies;
        ...
        var indexArr={"shouye-nor-":"shouye-sel-","touzi-nor":"touzi-sel","zichan":"zichan-sel-","wode1":"wode-sel-"};
		var indexActiveArr={"shouye-sel-":"shouye-nor-","touzi-sel":"touzi-nor","zichan-sel-":"zichan","wode-sel-":"wode1"};
        ...
        if (activeTab) {
            ...
            if(activeTab.querySelectorAll('span').length&&activeTab.querySelectorAll('span')[0].classList.contains('mui-icon')){
				var iconClassName=activeTab.querySelectorAll('span')[0].className;
				var replaceKey=iconClassName.replace('mui-icon iconfont icon-','');
				activeTab.querySelectorAll('span')[0].className= iconClassName.replace(replaceKey,indexActiveArr[replaceKey]);
			}
        }
        ...
        if (targetTab) {
            ...
            if(targetTab.querySelectorAll('span').length&&targetTab.querySelectorAll('span')[0].classList.contains('mui-icon')){
				var iconClassName=targetTab.querySelectorAll('span')[0].className;
				var replaceKey=iconClassName.replace('mui-icon iconfont icon-','');
				targetTab.querySelectorAll('span')[0].className= iconClassName.replace(replaceKey,indexArr[replaceKey]);
			}
        }
