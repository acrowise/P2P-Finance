...
! function(e, t, i, n) {
	...
	p.prototype.findElementItems = function() {
		...
		var e = this;
		return(e.items[e.getSelectedIndex()] || {}).v
	}, p.prototype.getSelectedText = function() {
		var e = this;
		return(e.items[e.getSelectedIndex()] || {}).t
	}, p.prototype.setSelectedValue = function(e, t, i) {
		var n = this;
		for(var a in n.items) {
			var r = n.items[a];
			if(r.v == e) return void n.setSelectedIndex(a, t, i)
		}
...
function(e, t) {
	...
	var i = '<div class="mui-poppicker">		<div class="mui-poppicker-header">			<button class="mui-poppicker-btn-cancel mui-btn-link">取消</button>			<button class="mui-btn-link mui-poppicker-btn-ok">确定</button>			<div class="mui-poppicker-clear"></div>		</div>		<div class="mui-poppicker-body">		</div>	</div>',
...
function(e, t) {
	...
	var i = '<div class="mui-dtpicker" data-type="datetime">		<div class="mui-dtpicker-header">			<button data-id="btn-cancel" class="mui-btn-link">取消</button>			<button data-id="btn-ok" class="mui-btn-link">确定</button>		</div>		<div class="mui-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>		<div class="mui-dtpicker-body">			<div data-id="picker-y" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-m" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-d" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-h" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-i" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>		</div>	</div>';
	e.DtPicker = e.Class.extend({
		...
		getSelected: function() {
			...
			switch(i) {
				case "datetime":
					n.v = n.y.v + "-" + n.m.v + "-" + n.d.v + " " + n.h.v + ":" + n.i.v, n.t = n.y.t + "-" + n.m.t + "-" + n.d.t + " " + n.h.t + ":" + n.i.t;
					break;
				case "date":
					n.v = n.y.v + "-" + n.m.v + "-" + n.d.v, n.t = n.y.t + "-" + n.m.t + "-" + n.d.t;
					break;
				case "time":
					n.v = n.h.v + ":" + n.i.v, n.t = n.h.t + ":" + n.i.t;
					break;
				case "month":
					n.v = n.y.v + "-" + n.m.v, n.t = n.y.t + "-" + n.m.t;
					break;
				case "hour":
					n.v = n.y.v + "-" + n.m.v + "-" + n.d.v + " " + n.h.v, n.t = n.y.t + "-" + n.m.t + "-" + n.d.t + " " + n.h.t
			}
			return n
		},
		...
		_create: function(e) {
			...
			var r = t.ui;
			t._setLabels(), t._setButtons(), r.picker.setAttribute("data-type", e.type), t._createYear(), t._createMonth(), t._createDay(), t._createHours(), t._createMinutes(), t.setSelectedValue(e.v)
		},
		show: function(i) {
			var n = this,
				a = n.ui;
